                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="produto in produtos" :key="produto.id" class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{produto.title}}</th>
                            <td class="px-4 py-3">{{produto.category_id}}</td>
                            <td class="px-4 py-3">{{ produto.brand_id }}</td>
                            <td class="px-4 py-3">{{produto.quantity}}</td>
                            <td class="px-4 py-3">{{ produto.price }}</td>
                            <td class="px-4 py-3">{{produto.inStock}}</td>
                            <td class="px-4 py-3">{{ produto.published }}</td>
